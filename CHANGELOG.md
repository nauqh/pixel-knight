...
- **Demo in the README.** Replaced the static screenshot with a short silent
  clip of a raid (`docs/demo.mp4`), linked from the README on GitHub. The clip is
  not shipped inside the extension package — it is documentation only.
